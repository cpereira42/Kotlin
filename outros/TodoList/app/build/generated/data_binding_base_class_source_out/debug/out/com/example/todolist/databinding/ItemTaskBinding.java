...
public final class ItemTaskBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView labelPriority;

  @NonNull
  public final TextView textViewName;

  private ItemTaskBinding(@NonNull ConstraintLayout rootView, @NonNull CheckBox checkBoxCompleted,
      @NonNull ImageView labelPriority, @NonNull TextView textViewName) {
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView labelPriority = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemTaskBinding((ConstraintLayout) rootView, checkBoxCompleted, labelPriority,
          textViewName);
    }
