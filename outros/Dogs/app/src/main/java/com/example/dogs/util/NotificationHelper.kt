...
class NotificationHelper (val context: Context) {
    ...
    fun createNotification(){
        ...
        val notificarion = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .build()
        NotificationManagerCompat.from(context).notify(NOTIFICATION_ID, notificarion)
    }
